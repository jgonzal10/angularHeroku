...
var AppComponent = /** @class */ (function () {
    function AppComponent(_movieService) {
        ...
        this.title = 'stars';
        this._movieService.getMovies(1).subscribe(function (data) {
            console.log(data);
        });
    }
    ;
...
var MoviesService = /** @class */ (function () {
     ...
     * @return movies
     */
    MoviesService.prototype.getMovies = function (page) {
        return this.http.get(this._url + '/movies?page=' + page)
            .catch(this.errorHandler);
    };
    MoviesService.prototype.errorHandler = function (error) {
